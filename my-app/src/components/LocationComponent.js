            ...
            <Row style={{ padding: '0px', margin: '0px' }}>
                ...
                <Col sm={6}>
                    <div id="location-section">
                        ...
                        <br />
                        <h3>Address</h3>
                        <p>Waikele Premium Outlet</p>
                        <p>94-790 Lumiaina St, Waipahu, HI 96797</p>
                        <button className="pri-color"><a style={{ color: 'black', textDecoration: 'none' }} href="https://www.google.com/maps/place/Waikele+Kitchen+and+Aloha+Coffee+%26+Tea/@21.4025157,-158.00927,17z/data=!3m1!4b1!4m6!3m5!1s0x7c006700500eea67:0x9d76835f264a1e02!8m2!3d21.4025157!4d-158.0066951!16s%2Fg%2F11vyq8v5td?entry=ttu" target="_blank" rel="noopener noreferrer">Google Maps</a></button>
                        <br />
                        <br />
                        <h3>Hours</h3>
